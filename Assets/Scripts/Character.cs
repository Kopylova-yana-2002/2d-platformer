...
/**
 * @brief Класс, реализующий основную логику играбельного персонажа
 */
public class Character : Unit
{
    ...
    /**
     * @brief Метод, вызывающийся каждый фиксированный прометжуток времени
    ...
    /**
     * @brief Метод для перемещения персонажа по горизонтали
     */
    private void Run()
    {
    ...
    /**
     * @brief Метод для совершения прыжка
     */
    private void Jump()
    {
    ...
    /**
     * @brief Метод, обрабатывающий получение урона
     */
    ...
    /**
     * @brief Метод проверяет находится ли персонаж на земле и меняет соответствующие поля
     */
